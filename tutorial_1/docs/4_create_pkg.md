...
Checkout https://docs.ros.org/en/humble/Tutorials/Beginner-Client-Libraries/Creating-Your-First-ROS2-Package.html for more details. You can use ament_cmake for C++ based development of your package.